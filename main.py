...
if __name__ == "__main__":
    allowed_for_each_type: dict[PackageType, list[PackageManager]] = {
        PackageType.GUI_APP: [PackageManager.FLATPAK, PackageManager.SNAP, PackageManager.SNAP_CLASSIC, PackageManager.APT, PackageManager.NIX],
        PackageType.CLI: [PackageManager.APT, PackageManager.SNAP, PackageManager.SNAP_CLASSIC, PackageManager.BREW],
